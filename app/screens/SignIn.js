          ...
          >
            <View
              style={[
                ...
                { paddingHorizontal: spacing(3), paddingVertical: spacing(4) },
              ]}
            >
              <View style={styles.heroArea}>
                ...
                >
                  <Chip
                    ...
                    textStyle={{ fontWeight: '600', letterSpacing: 0.5 }}
                    style={[
                      styles.badge,
                      {
                ...
                <Text
                  ...
                  allowFontScaling
                >
                  Authenticate to synchronize your revenue streams and real-time forecasts.
                </Text>
              </View>
              ...
              <GlassCard accessibilityLabel="Sign in to HustleLedger command deck">
                ...
                {!!err && (
                  <Text
                    style={{ color: dangerColor, marginBottom: spacing(1) }}
                    allowFontScaling
                  >
                    {err}
                  </Text>
