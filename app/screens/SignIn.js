            ...
            <View style={styles.contentWrapper}>
              <View style={styles.heroArea}>
                <View
                  style={[
                    styles.badgeGlow,
                    { backgroundColor: isDark ? 'rgba(90, 72, 200, 0.25)' : 'rgba(90, 72, 200, 0.12)' },
                  ]}
                >
                  <Chip
                    mode="outlined"
                    ...
                    accessibilityLabel="Priority access badge"
                  >
                ...
                <Text
                  ...
                  allowFontScaling
                >
                  Your AI finance officer is synced and ready with real-time cash intelligence to guide every decision.
                </Text>
              </View>
