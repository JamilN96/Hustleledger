...
export default function SignIn({ navigation }) {
  ...
  const cardOutline = colors.cardOutline ?? cardBorder;
  const inputBackground =
    colors.inputBackground ?? (isDark ? 'rgba(9, 14, 29, 0.6)' : 'rgba(255, 255, 255, 0.88)');
    ...
    >
      ...
      >
        ...
        <SafeAreaView style={styles.flex}>
          <ScrollView
            contentContainerStyle={{ flexGrow: 1, padding: spacing(3) }}
            ...
            <View style={styles.contentWrapper}>
              <View style={styles.heroArea}>
                <View
                  ...
                  accessibilityLabel="AI-synced finance badge"
                >
                  <Chip
                    style={[
                      styles.badge,
                ...
                <Text style={[styles.heroDescription, { color: subtextColor }]} allowFontScaling>
                  Monitor performance, automate savings, and unlock new revenue streams from a secure
                  control center.
                </Text>
              </View>
                ...
                <View style={{ marginBottom: spacing(2) }}>
                  <View
                    style={{
                      ...
                      borderWidth: 1,
                      borderColor: focusedField === 'email' ? `${colors.accent2}88` : cardOutline,
                      overflow: 'hidden',
                    }}
                  >
                    <TextInput
