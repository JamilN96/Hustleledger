              ...
              <View style={styles.heroArea}>
                ...
                >
                  <Chip
                    ...
                    style={[
                      styles.badge,
                      { backgroundColor: badgeBackground, borderColor: cardBorder },
                    ]}
                    textStyle={{ color: colors.accent2, fontWeight: '600' }}
                    accessibilityLabel="Biometric security badge"
                  >
                    Secure Access
                  </Chip>
                </View>
                ...
                <Text style={[styles.heroHeadline, { color: colors.text }]} allowFontScaling>
                  Command your finances with AI precision
                </Text>
                <Text style={[styles.heroDescription, { color: subtextColor }]} allowFontScaling>
                  Sync every hustle, reveal insights, and activate daily cash rituals.
                </Text>
              </View>
